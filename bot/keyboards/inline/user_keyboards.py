...
def get_payment_method_keyboard(months: int, price: float,
    ...
    PLATEGA_METHOD_KEYS: Dict[int, str] = {
        2:  "pay_with_platega_sbp_button",
        3:  "pay_with_platega_erip_button",
        11: "pay_with_platega_card_rf_button",
        12: "pay_with_platega_card_intl_button",
        13: "pay_with_platega_crypto_button",
    }
    ...
    for method in settings.payment_methods_order:
        if method == "severpay" and getattr(settings, "SEVERPAY_ENABLED", False):
            ...
            try:
                ...
                continue
            i18n_key = PLATEGA_METHOD_KEYS.get(method_id, "pay_with_platega_button")
            builder.button(
                text=_(i18n_key),
